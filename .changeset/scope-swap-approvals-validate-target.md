...
EVM swaps are now checked against a small route allowlist for supported Base aggregators before approval or signing, including the swap target and approval spender.

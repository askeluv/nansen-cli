...
Telemetry: anonymous usage stats (commands, timing, errors). Perp order/close also send trade details — asset, side, order type, sizes, prices, order id, TP/SL outcomes — tied to a random anonymous id. Disable: DO_NOT_TRACK=1
`;
